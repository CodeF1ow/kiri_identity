...
function setIdentity(identifier, data, callback)
	...
	MySQL.Async.execute('INSERT INTO pop_inventory (identifier) VALUES (@identifier)', {
		['@identifier']		= identifier
	})
...
AddEventHandler('esx_identity:setIdentity', function(data, myIdentifiers)
	setIdentity(myIdentifiers.steamid, data, function(callback)
		if callback then
			...
			TriggerClientEvent('chat:addMessage', source, { args = { '^[DNI]', 'No se pudo crear el personaje, contacta a un administrador!' } })
		end
	end)
end)
